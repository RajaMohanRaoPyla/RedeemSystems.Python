#Program on using __gt__ & __lt__ comparsion operator
...
class Circle:
    ...
    def __gt__(self, another_circle):           #using greater than comparision operator.
        return self.__radius > another_circle.__radius

    def __lt__(self, another_circle):           #using less than comparision operator.
        return self.__radius < another_circle.__radius
